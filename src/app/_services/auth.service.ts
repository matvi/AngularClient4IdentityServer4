...
// This Service is used for login in through the IdentityServer using the Hybrid flow
// This Service uses the oidc-client to call the IdentityServer for authentication using the Flow defined in the response_type (in this case the Hybrid Flow)
